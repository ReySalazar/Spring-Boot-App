package com.reysl.SpringBootApp.controller;
...
import com.reysl.SpringBootApp.Repository.RoleRepository;
import com.reysl.SpringBootApp.service.UserService;
...
public class UserController {
	...
	public String getEditUserForm(Model model, @PathVariable(name="id")Long id) throws Exception {
		User userToEditUser = userService.getUserById(id);
		
		model.addAttribute("userForm", userToEditUser);
		model.addAttribute("userList", userService.getAllUsers());
		model.addAttribute("roles", roleRepository.findAll());
		model.addAttribute("formTab", "active");
